...
export const DINOSAURS: Dinosaur[] = [
  {
    ...
    paleoEnvironment: 'Floodplain',
    discoveryYear: 1902,
    discoveredBy: 'Barnum Brown',
    fossilLocations: ['Hell Creek Formation, USA', 'Lance Formation, USA'],
    specimenCompletenessPct: 50,
    holotypeCatalogId: 'CM 9380',
    fossilSpecimenCount: 50,
    shortDescription:
    ...
    biteForceNewtons: 35000,
    brainToBodyRatio: 0.6,
    temperatureRegulation: 'Mesothermic',
    evidenceOfFeathers: false,
    lifeSpanYears: 30,
    clutchSize: 15,
    eggDiameterCm: 43,
    parentalCare: 'Guarding',
    socialBehavior: 'Pack',
    absoluteAgeMa: { start: 68, end: 66 },
    notableSpecimens: ['Sue', 'Stan'],
    referencePapers: ['Osborn 1905', 'Hurum & Sabath 2003'],
    featuredInMedia: ['Jurassic Park', 'Night at the Museum'],
    emoji: '🦖'
  },
  {
    name: 'Stegosaurus',
    ...
    paleoEnvironment: 'Forest',
    discoveryYear: 1877,
    discoveredBy: 'Othniel Charles Marsh',
    fossilLocations: ['Morrison Formation, USA'],
    specimenCompletenessPct: 70,
    holotypeCatalogId: 'USNM 4934',
    fossilSpecimenCount: 30,
    shortDescription:
    ...
    biteForceNewtons: 3000,
    brainToBodyRatio: 0.1,
    ...
    parentalCare: 'None',
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 155, end: 150 },
    notableSpecimens: ['Sophie'],
    referencePapers: ['Marsh 1877'],
    featuredInMedia: ['Walking with Dinosaurs'],
    emoji: '🦕'
  },
  {
    name: 'Triceratops',
    ...
    paleoEnvironment: 'Plains',
    discoveryYear: 1889,
    discoveredBy: 'O. C. Marsh',
    fossilLocations: ['Hell Creek Formation, USA'],
    specimenCompletenessPct: 75,
    holotypeCatalogId: 'YPM 1820',
    fossilSpecimenCount: 70,
    shortDescription:
    ...
    biteForceNewtons: 8000,
    brainToBodyRatio: 0.3,
    temperatureRegulation: 'Mesothermic',
    evidenceOfFeathers: false,
    lifeSpanYears: 25,
    clutchSize: 8,
    ...
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 68, end: 66 },
    notableSpecimens: ['Big John'],
    referencePapers: ['Horner & Goodwin 2006'],
    featuredInMedia: ['The Land Before Time'],
    emoji: '🦕'
  },
  {
    name: 'Velociraptor',
    ...
    paleoEnvironment: 'Desert',
    discoveryYear: 1924,
    discoveredBy: 'Henry Fairfield Osborn',
    fossilLocations: ['Djadochta Formation, Mongolia'],
    specimenCompletenessPct: 60,
    holotypeCatalogId: 'MPC-D 100/25',
    fossilSpecimenCount: 20,
    shortDescription:
    ...
    biteForceNewtons: 1500,
    brainToBodyRatio: 1.0,
    temperatureRegulation: 'Endothermic',
    evidenceOfFeathers: true,
    lifeSpanYears: 15,
    clutchSize: 10,
    eggDiameterCm: 7,
    parentalCare: 'Brooding',
    socialBehavior: 'Pack',
    absoluteAgeMa: { start: 75, end: 71 },
    notableSpecimens: ['Fighting Dinosaurs'],
    referencePapers: ['Norell & Makovicky 2004'],
    featuredInMedia: ['Jurassic Park'],
    emoji: '🦖'
  },
  {
    name: 'Brachiosaurus',
    ...
    fossilLocations: ['Morrison Formation, USA'],
    specimenCompletenessPct: 40,
    holotypeCatalogId: 'FMNH P25107',
    fossilSpecimenCount: 5,
    shortDescription:
    ...
    biteForceNewtons: 1000,
    brainToBodyRatio: 0.05,
    temperatureRegulation: 'Mesothermic',
    evidenceOfFeathers: false,
    lifeSpanYears: 80,
    clutchSize: 20,
    ...
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 154, end: 153 },
    referencePapers: ['Riggs 1903'],
    featuredInMedia: ['Jurassic Park'],
    emoji: '🦕'
  },
  {
    ...
    specimenCompletenessPct: 25,
    holotypeCatalogId: 'IPHG 1912 VIII',
    fossilSpecimenCount: 10,
    shortDescription:
    ...
    biteForceNewtons: 20000,
    brainToBodyRatio: 0.5,
    temperatureRegulation: 'Mesothermic',
    evidenceOfFeathers: false,
    lifeSpanYears: 25,
    clutchSize: 12,
    ...
    absoluteAgeMa: { start: 99, end: 93 },
    referencePapers: ['Ibrahim et al. 2014'],
    featuredInMedia: ['Jurassic Park III'],
    emoji: '🦖'
  },
  {
    name: 'Ankylosaurus',
    ...
    discoveredBy: 'Barnum Brown',
    fossilLocations: ['Hell Creek Formation, USA'],
    specimenCompletenessPct: 20,
    holotypeCatalogId: 'AMNH 5895',
    fossilSpecimenCount: 7,
    shortDescription:
    ...
    socialBehavior: 'Solitary',
    absoluteAgeMa: { start: 68, end: 66 },
    referencePapers: ['Brown 1908'],
    featuredInMedia: ['Jurassic World'],
    emoji: '🦕'
  },
  {
    name: 'Allosaurus',
    ...
    specimenCompletenessPct: 80,
    holotypeCatalogId: 'YPM 1930',
    fossilSpecimenCount: 60,
    shortDescription:
    ...
    socialBehavior: 'Pack',
    absoluteAgeMa: { start: 155, end: 150 },
    referencePapers: ['Chure 2000'],
    featuredInMedia: ['Jurassic World Evolution'],
    emoji: '🦖'
  },
  {
    name: 'Diplodocus',
    ...
    parentalCare: 'Unknown',
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 154, end: 150 },
    notableSpecimens: ['Dippy'],
    referencePapers: ['Hatcher 1901'],
    emoji: '🦕'
  },
  {
    ...
    specimenCompletenessPct: 45,
    holotypeCatalogId: 'ROM 768',
    fossilSpecimenCount: 15,
    shortDescription:
    ...
    parentalCare: 'Guarding',
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 76, end: 73 },
    referencePapers: ['Parks 1922'],
    emoji: '🦕'
  },
  {
    name: 'Iguanodon',
    ...
    specimenCompletenessPct: 90,
    holotypeCatalogId: 'NHMUK R5764',
    fossilSpecimenCount: 30,
    shortDescription:
    ...
    parentalCare: 'Guarding',
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 140, end: 125 },
    referencePapers: ['Mantell 1825'],
    emoji: '🦕'
  },
  {
    name: 'Pteranodon',
    ...
    specimenCompletenessPct: 30,
    holotypeCatalogId: 'YPM 2594',
    fossilSpecimenCount: 120,
    shortDescription:
    ...
    biteForceNewtons: 200,
    brainToBodyRatio: 1.5,
    temperatureRegulation: 'Endothermic',
    evidenceOfFeathers: true,
    lifeSpanYears: 15,
    clutchSize: 2,
    ...
    parentalCare: 'Brooding',
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 86, end: 84 },
    referencePapers: ['Bennett 1994'],
    emoji: '🦅'
  },
  {
    name: 'Apatosaurus',
    ...
    parentalCare: 'Unknown',
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 154, end: 151 },
    referencePapers: ['Marsh 1877'],
    emoji: '🦕'
  },
  {
    ...
    absoluteAgeMa: { start: 69, end: 66 },
    referencePapers: ['Brown & Schlaikjer 1943'],
    emoji: '🦖'
  },
  {
    name: 'Gallimimus',
    ...
    specimenCompletenessPct: 60,
    holotypeCatalogId: 'GIN 100/1133',
    fossilSpecimenCount: 20,
    shortDescription:
    ...
    parentalCare: 'Guarding',
    socialBehavior: 'Herd',
    absoluteAgeMa: { start: 71, end: 69 },
    referencePapers: ['Osmólska et al. 1972'],
    emoji: '🦖'
  },
  {
    name: 'Deinonychus',
    ...
    specimenCompletenessPct: 50,
    holotypeCatalogId: 'YPM 5205',
    fossilSpecimenCount: 12,
    shortDescription:
    ...
    parentalCare: 'Brooding',
    socialBehavior: 'Pack',
    absoluteAgeMa: { start: 115, end: 108 },
    referencePapers: ['Ostrom 1969'],
    emoji: '🦖'
  },
  {
    name: 'Dilophosaurus',
    ...
    specimenCompletenessPct: 40,
    holotypeCatalogId: 'UCMP 37302',
    fossilSpecimenCount: 6,
    shortDescription:
    ...
    parentalCare: 'Unknown',
    socialBehavior: 'Pack',
    absoluteAgeMa: { start: 193, end: 190 },
    referencePapers: ['Welles 1984'],
    featuredInMedia: ['Jurassic Park'],
    emoji: '🦖'
  },
  // {
